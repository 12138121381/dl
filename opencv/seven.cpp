...
void getContours(Mat imgDil, Mat img) {
	...
	for (int i = 0; i < contours.size(); i++) 
	{
		...
		if (area > 1000) //过滤噪声
		{
			...
			cout << "conPoly[i].size()=" << conPoly[i].size() << endl;
...
int main()
{
	string path = "C:/Users/86157/Desktop/opencv练习/756542b89152a0995eef3e1745adc585_watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDYxMzA2Mw==,size_16,color_FFFFFF,t_70#pic_center.jpg";
	Mat img = imread(path);
